...
layers = (50, 30)
clf = MLPClassifier(n_jobs=7, solver='lbfgs', hidden_layer_sizes=(layers), max_iter=1000, random_state=1)
y_pred = cross_val_predict(clf, X, y, cv=20)
